...
class MP_Profiler extends CI_Profiler {
	...
	protected function _compile_queries()
	{
		...
		$highlight = array('SET&nbsp;', 'SESSION&nbsp;', 'SELECT&nbsp;', 'DISTINCT&nbsp;', 'FROM&nbsp;', 'WHERE&nbsp;', 'AND&nbsp;', 'LEFT&nbsp;JOIN&nbsp;', 'ORDER&nbsp;BY&nbsp;', 'GROUP&nbsp;BY&nbsp;', 'LIMIT&nbsp;', 'INSERT&nbsp;', 'INTO&nbsp;', 'VALUES&nbsp;', 'UPDATE&nbsp;', 'OR&nbsp;', 'HAVING&nbsp;;', 'OFFSET&nbsp;', 'NOT&nbsp;IN&nbsp;', 'IN&nbsp;', 'LIKE&nbsp;', 'NOT&nbsp;LIKE&nbsp;', 'COUNT&nbsp;', 'MAX&nbsp;', 'MIN&nbsp;', 'ON&nbsp;', 'AS&nbsp;', 'AVG&nbsp;', 'SUM&nbsp;');
...
/* End of file MP_Profiler.php */
/* Location: ./megapublik/libraries/MP_Profiler.php */
