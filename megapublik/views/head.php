...
<head>
	...
	<?php if (defined('AJAX')) : ?>
	<script charset="utf-8" type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.6.3/jquery.min.js"></script>
	<script type="text/javascript" charset="utf-8">
	<!--
		if(typeof jQuery==='undefined'){
			document.write(unescape('<scri'+'pt src="<?php echo base_url(); ?>javascript/jquery-1.6.3.min.js" type="text/javascript" charset="utf-8"></scri'+'pt>'));
		}
	//-->
	</script>
	<script type="text/javascript" charset="utf-8">
