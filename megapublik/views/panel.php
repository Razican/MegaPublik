...
<div id="money_mp">MP: <?php echo number_format($user->money_mp, 2, $l18n->dec, $l18n->thou); ?></div>
<div id="money_mp"><?php echo $country->currency; ?>: <?php echo number_format(country_money($user, $country), 2, $l18n->dec, $l18n->thou); ?></div>
