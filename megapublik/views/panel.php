...
<div class="money">MP: <?php echo number_format(isset($user->money['MP']) ? $user->money['MP'] : 0, 2, $l18n->dec, $l18n->thou); ?></div>
<div class="money"><?php echo $country->currency; ?>: <?php echo number_format(country_money($user, $country), 2, $l18n->dec, $l18n->thou); ?></div>
