		<footer>
		<?php if(empty($email)) : ?><div class="online_users"><?php echo lang('overal.total_users').': '.online_users(); ?></div><?php endif; ?>
			<div class="copyright">
				<a rel="license" href="http://creativecommons.org/licenses/by-sa/3.0/deed.<?php echo $this->lang->lang(); ?>"><img alt="Licencia Creative Commons" style="border-width:0" src="images/license.png"></a><br>
